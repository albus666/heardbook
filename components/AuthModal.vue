    ...
    <div v-if="show" class="modal modal--auth-popup" @click.self="handleClose">
      <div class="modal__wrapper">
        <div class="modal__resizer">
          <!-- 容器高度过渡和白色遮罩逻辑 -->
          <div class="modal__container" ref="container" :style="{ height: containerHeight }">
            ...
            <div class="modal__step" ref="modalStep" :class="{ 'modal__step--fading-out': isFadingOut, 'modal__step--transitioning': isTransitioning }">
              <transition name="content-slide" mode="out-in">
                <!-- ==================================================================================================== -->
                <!-- SIGNUP FORM (Adapted from SignUpModal.vue) -->
                <!-- ==================================================================================================== -->
                <div v-if="tempMode === 'signup'" key="signup" :class="['auth-popup-form', 'auth-popup-form--signup', { 'content-fade-out': isFadingOut && tempMode === 'signup' }]">
                  <div class="auth-popup-form__container">
                    <div class="auth-popup-form__header">
                      <h3 class="auth-popup-form__headline">Sign up for Heardly</h3>
                    ...
                    <div class="auth-popup-form__body">
                      <form @submit.prevent="handleSignup" class="signup-form">
                        ...
                        <div class="mt-4 signup-form__legal text-center">
                          ...
                          <a href="mailto:support@heardly.com" target="_blank">support@heardly.com</a>.
                ...
                <!-- ==================================================================================================== -->
                <div v-else-if="tempMode === 'login'" key="login" :class="['login-modal-form', { 'content-fade-out': isFadingOut && tempMode === 'login' }]">
                  <div class="login-modal-form__container">
                    <div class="login-modal-form__header">
                      <h3 class="login-modal-form__headline">Log in to Heardly</h3>
                    </div>
                            ...
                            >
                              <span class="social-button__label">
                                <svg xmlns="http://www.w3.org/2000/svg" width="150" height="16" viewBox="0 0 150 16" fill="none" class="sprite sprite--auth-form sprite--continue_with_apple_en">
                                  <!-- SVG path placeholder - fill this yourself -->
            ...
            <!-- 隐藏的测量容器，用于提前测量新内容高度 -->
            <div ref="measureContainer" class="modal__measure" style="visibility: hidden; position: absolute; left: -9999px; top: 0; width: 392px;">
              <div class="modal__step">
                <div v-if="mode === 'signup'" class="auth-popup-form auth-popup-form--signup">
                  <div class="auth-popup-form__container">
                    ...
                    <div class="auth-popup-form__body">
                      <form class="signup-form">
                        ...
                        <div class="form__field signup-form__input">
                          <div class="form__field-container">
                            <input type="password" placeholder="Create password" class="form__input" />
                            <button type="button" class="form__password-toggle password-toggle">
                              <span class="password-toggle__label">Show</span>
                            </button>
                          </div>
                        </div>
                        <button type="submit" class="signup-form__cta button button--full">
                          <span>Create account</span>
                        </button>
                        <div>
                          <div class="signup-form__separator">
                          ...
                          <button type="button" class="mb-4 signup-form__facebook-button button button--facebook button--full button--icon-32">
                            <img src="/img/auth/facebook.svg" alt="Facebook Icon" />
                            <span>Sign up with Facebook</span>
                          </button>
                        </div>
                        <button type="button" class="mb-4 signup-form__google-button button button--google button--full button--icon-32">
                          <img src="/img/auth/google.svg" alt="Google Icon" />
                          <span>Sign up with Google</span>
                        </button>
                        <a href="/auth/b2b" class="block mt-4 px-4 rounded border-none font-cera-pro font-medium text-base leading-5 text-center items-center justify-center no-underline outline-none cursor-pointer disabled:cursor-not-allowed bg-midnight text-white hover:bg-deep-black hover:text-white py-3">
                          Sign up with SSO
                        </a>
                        <div class="mt-4 signup-form__legal text-center">
                          Start your learning journey! By submitting, you'll get exciting email updates about our products. Unsubscribe anytime via the link or
                          <a href="mailto:support@heardly.com" target="_blank">support@heardly.com</a>.
                          Discover more about how we protect your data in our
                          <a target="_blank" class="text-mid-grey underline" href="/privacy">Privacy Policy</a>.
                          Our <a target="_blank" href="/tos" class="text-mid-grey underline">Terms</a> apply.
                  ...
                  <a class="auth-popup-form__footer auth-popup-form__toggle-form" href="#">
                    Already have an account?
                  </a>
                </div>
                <div v-else-if="mode === 'login'" class="login-modal-form">
                  <div class="login-modal-form__container">
                    <div class="login-modal-form__header">
                      <h3 class="login-modal-form__headline">Log in to Heardly</h3>
                    </div>
                    <div class="login-modal-form__body login-form-body">
                      <form class="login-form">
                        <div class="login-form__social-logins">
                          <div class="login-form__social-logins-row">
                            <a class="social-button social-button--facebook" href="#">
                              <span class="social-button__sprite">
                                <img src="/img/auth/facebook.svg" alt="Facebook Icon" class="sprite sprite--auth-form sprite--facebook" />
                              </span>
                          ...
                          <div class="login-form__social-logins-row">
                            <a :href="appleLoginUrl" class="social-button social-button--apple">
                              <span class="social-button__label">
                                <svg xmlns="http://www.w3.org/2000/svg" width="150" height="16" viewBox="0 0 150 16" fill="none" class="sprite sprite--auth-form sprite--continue_with_apple_en">
                                  <!-- SVG path placeholder - fill this yourself -->
                          ...
                          <div class="login-form__social-logins-row">
                            <a class="login-form__button login-form__button--midnight login-form__sso-button" href="/auth/b2b">
                              Log in with SSO
                            </a>
                          </div>
                        </div>
                        ...
                        <div class="login-form__field login-form__field--text">
                          <div class="login-form__field-container">
                            <input type="email" placeholder="Email" class="login-form__input" />
                          </div>
                        </div>
                        <div class="login-form__field login-form__field--password">
                          <div class="login-form__field-container">
                            <input type="password" placeholder="Password" class="login-form__input" />
                            <button type="button" class="login-form__password-toggle">
                              <span class="login-form__password-toggle-label">Show</span>
                            </button>
                          </div>
                        </div>
                        <button type="submit" class="login-form__button login-form__button--full login-form__submit-btn">
                  ...
                  <div class="login-modal-form__footer">
                    <a class="login-modal-form__toggle-form" href="#">
                      You don't have an account?
                    </a>
                  </div>
                </div>
...
export default {
  ...
  data() {
    return {
      mode: this.initialMode, // 目标模式
      tempMode: this.initialMode, // 实际渲染的内容模式
      showPassword: false,
      containerHeight: 'auto',
      isTransitioning: false, // 标记是否正在切换
      isFadingOut: false, // 标记内容是否正在淡出
  ...
  watch: {
    ...
    mode(newMode, oldMode) {
      if (newMode !== oldMode && this.show) {
        // 只在模态框显示时才处理切换
        // switchToLogin/switchToSignup 会调用 handleModeTransition
      }
    },
    show(newVal) {
      if (!newVal) {
        ...
        this.tempMode = this.initialMode; // 确保 tempMode 也同步
        this.isFadingOut = false
        this.isTransitioning = false
        this.$nextTick(() => {
  ...
  beforeDestroy() {
    ...
    if (this.$refs.container) {
      this.$refs.container.removeEventListener('transitionend', this.onTransitionEnd)
    }
  },
  methods: {
    handleClose() {
    ...
    handleModeTransition() {
      ...
      // 3. 先锁定旧高度
      this.containerHeight = `${oldHeight}px`

      // 4. 等待 DOM 更新，然后用隐藏容器测量新内容高度
      this.$nextTick(() => {
        // 使用双重 requestAnimationFrame 确保隐藏容器已渲染
        requestAnimationFrame(() => {
          requestAnimationFrame(() => {
            ...
            // 确保高度值不同，才能触发 transition
            if (Math.abs(newHeight - oldHeight) > 1) {
              // 创建 transitionend 事件处理函数
              const onTransitionEnd = (e) => {
                ...
                if (e.target === this.$refs.container && e.propertyName === 'height') {
                  ...
                  this.$nextTick(() => {
                    this.isTransitioning = false
                    // 清除可能残留的 Vue transition 类（不影响淡入动画）
                    this.$nextTick(() => {
                      this.ensureContentVisible()
                    })
                  })
              ...
              // 关键优化：在高度动画开始的同一帧就切换内容
              // 内容先渲染但保持透明，等高度动画结束再淡入
              this.tempMode = this.mode
              
              // 等待内容渲染，然后设置内容为透明并开始高度动画
              this.$nextTick(() => {
                // 强制 reflow，确保下面的高度变化能触发 transition
    ...
    updateContainerHeight() {
      // 只在模态框显示时更新高度
      if (this.show && this.$refs.modalStep) {
        const height = this.$refs.modalStep.offsetHeight
        if (height > 0 && this.containerHeight === 'auto') {
          this.containerHeight = `${height}px`
        }
      }
    },
    ensureContentVisible() {
      // 强制恢复内容可见，清除可能残留的 transition 类
      if (this.$refs.modalStep) {
        const content = this.$refs.modalStep.querySelector('.auth-popup-form, .login-modal-form')
        if (content) {
          content.style.opacity = '1'
          content.style.transform = 'none'
          // 移除可能残留的 transition 类
          content.classList.remove('content-slide-enter', 'content-slide-enter-active', 'content-slide-enter-to')
          content.classList.remove('content-slide-leave', 'content-slide-leave-active', 'content-slide-leave-to')
        }
      }
    },
    switchToLogin() {
...
.modal__container {
  ...
  will-change: height; /* 优化 transition 性能 */
}
...
/* 内容淡出动画（双线加载的第一条线）- 点击切换时立即触发 */
.content-fade-out {
  transition: opacity 0.3s ease !important;
  opacity: 0 !important;
}

/* 确保内容默认可见，当 content-fade-out 类被移除时能正确淡入 */
.auth-popup-form,
.login-modal-form {
  transition: opacity 0.3s ease;
  opacity: 1;
...
/* 内容淡出动画（双线加载的第一条线）- transition 方式 */
.modal__step--fading-out .content-slide-leave-active {
  transition: opacity 0.3s ease;
}

.modal__step--fading-out .content-slide-leave-to {
  opacity: 0;
}

/* 切换时，新内容的淡入动画 */
.modal__step--transitioning .content-slide-enter-active {
  transition: opacity 0.3s ease; /* 允许淡入动画 */
}

.modal__step--transitioning .content-slide-enter {
  opacity: 0; /* 初始透明 */
}

.modal__step--transitioning .content-slide-enter-to {
  opacity: 1; /* 最终显示 */
}
...
/* Login Modal Form Styles (from LoginModal.vue) */
.login-modal-form {
  width: 100%;
}
...
/* Login Form Field Styles (from LoginModal.vue) */
.login-form__field {
...
/* Login Form Button Styles (from LoginModal.vue) */
.login-form__button {
  font: inherit;
  background: none;
...
/* Login Form Separator (from LoginModal.vue) */
...
/* Login Form Social Logins (from LoginModal.vue) */
...
/* Social Button Styles for Signup Form (keep padding for signup) */
.auth-popup-form--signup .social-button {
  display: flex;
  align-items: center;
  justify-content: center;
  flex: 1;
...
/* Social Button Styles (for login form - from LoginModal.vue) */
.social-button {
  -webkit-font-smoothing: antialiased;
  -webkit-tap-highlight-color: transparent;
  font-size: inherit;
...
/* Social Button Sprite and Label (from LoginModal.vue) */
...
/* Login Modal Form Footer (from LoginModal.vue) */
...
/* Auth Form Forgot Password (from LoginModal.vue) */
